package jordan.tutorial.init.blocks.furnaces;
...
public class BlockQuartzFurnace extends BlockContainer 
{
	...
	public BlockQuartzFurnace(boolean isBurning, String name) 
	{
		super(Material.ROCK);
    ...
    {
        return Item.getItemFromBlock(TutorialBlocks.QUARTZ_FURNACE);
    }
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos)
    {
        ...
        if (active)
        {
            worldIn.setBlockState(pos, TutorialBlocks.LIT_QUARTZ_FURNACE.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, TutorialBlocks.LIT_QUARTZ_FURNACE.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
        else
        {
            worldIn.setBlockState(pos, TutorialBlocks.QUARTZ_FURNACE.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, TutorialBlocks.QUARTZ_FURNACE.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
    ...
    {
        return new ItemStack(TutorialBlocks.QUARTZ_FURNACE);
    }
