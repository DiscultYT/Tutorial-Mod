...
public class TutorialNeatherGenMineable extends WorldGenerator
{
    ...
    public TutorialNeatherGenMineable(IBlockState state, int blockCount)
    {
        this(state, blockCount, BlockMatcher.forBlock(Blocks.NETHERRACK));
    }

    public TutorialNeatherGenMineable(IBlockState state, int blockCount, Predicate<IBlockState> p_i45631_3_)
    {
        this.oreBlock = state;
